//-----------------------------------------------------------------------
// <copyright file="GetRemoteDateTime.cs" company="None">
...
namespace Felsökning.Tomte.PowerShell.Commands.Get
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="GetRemoteDateTime"/> class.
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "RemoteDateTime")]
    public class GetRemoteDateTime : PSCmdlet
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                DateTime result = DateTime.Parse((string)newWorkflowServiceClient.InvokeWorkflow("DateTimeActivity"));
                WriteObject(result);
            }
        }
    }
