//-----------------------------------------------------------------------
// <copyright file="GetRemoteLoggedOnUsers.cs" company="None">
...
namespace Felsökning.Tomte.PowerShell.Commands.Get
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="GetRemoteLoggedOnUsers"/> class.
    /// </summary>
    /// <inheritdoc cref="PSCmdlet"/>
    [Cmdlet(VerbsCommon.Get, "RemoteLoggedOnUsers")]
    public class GetRemoteLoggedOnUsers : PSCmdlet
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                string result = (string)newWorkflowServiceClient.InvokeWorkflow("GetLoggedOnUsersActivity");
                WriteObject(result);
            }
        }
    }
