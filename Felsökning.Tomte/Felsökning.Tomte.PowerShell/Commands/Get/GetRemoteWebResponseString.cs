//-----------------------------------------------------------------------
// <copyright file="GetRemoteWebResponseString.cs" company="None">
...
namespace Felsökning.Tomte.PowerShell.Commands.Get
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="GetRemoteWebResponseString"/> class.
    /// </summary>
    /// <inheritdoc cref="PSCmdlet"/>
    [Cmdlet(VerbsCommon.Get, "RemoteWebResponseString")]
    public class GetRemoteWebResponseString : PSCmdlet
    {
        /// <summary>
        ...
        /// <summary>
        ///     Gets or sets the <see cref="Uri"/> value, which defines which command and parameter to pass.
        /// </summary>
        [Parameter(Position = 1, HelpMessage = "The URI to perform the GET against.", Mandatory = true)]
        [ValidateNotNullOrEmpty]
