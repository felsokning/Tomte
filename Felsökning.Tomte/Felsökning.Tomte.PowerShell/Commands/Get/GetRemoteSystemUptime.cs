//-----------------------------------------------------------------------
// <copyright file="GetRemoteSystemUptime.cs" company="None">
...
namespace Felsökning.Tomte.PowerShell.Commands.Get
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="GetRemoteSystemUptime"/> class.
    /// </summary>
    /// <inheritdoc cref="PSCmdlet"/>
    [Cmdlet(VerbsCommon.Get, "RemoteSystemUptime")]
    public class GetRemoteSystemUptime : PSCmdlet
    {
        /// <summary>
