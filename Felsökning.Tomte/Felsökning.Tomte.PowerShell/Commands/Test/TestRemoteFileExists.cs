//-----------------------------------------------------------------------
// <copyright file="TestRemoteFileExists.cs" company="None">
...
namespace Felsökning.Tomte.PowerShell.Commands.Test
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="TestRemoteFileExists"/> class.
    /// </summary>
    /// <inheritdoc cref="PSCmdlet"/>
    [Cmdlet(VerbsDiagnostic.Test, "RemoteFileExists")]
    public class TestRemoteFileExists : PSCmdlet
    {
        /// <summary>
